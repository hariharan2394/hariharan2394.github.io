...
module.exports = "<mat-toolbar color=\"primary\" style=\"margin:0\">\r\n   <h1>Create your To Do List</h1>   \r\n</mat-toolbar>\r\n<br><br>\r\n<div class=\"container\">\r\n<div class=\"row\">\r\n    <div class=\"col-lg-6 col-md col-sm offset-lg-3\">\r\n        <mat-card class='taskCreateCard'>\r\n            <mat-card-header>\r\n                <div mat-card-avatar class=\"taskIconimage\"></div>\r\n                <mat-card-title id=\"createTaskTitle\">Create new Task</mat-card-title>\r\n             </mat-card-header>\r\n\r\n            <mat-card-actions>\r\n                <form #formRef>\r\n                    <mat-card-content>\r\n                        <div class=\"row\">\r\n                            <mat-form-field class=\"col\">\r\n                                <input id=\"taskName\" type=\"text\" matInput placeholder=\"Task Name\" value=\"\" #newTaskEl>\r\n                            </mat-form-field>\r\n                        </div>\r\n                    </mat-card-content> \r\n                    <div class=\"row\" *ngIf=\"!edited\">\r\n                        <div class=\"col-1 offset-lg-8 offset-7\">\r\n                            <button class=\"cardBtn\" id=\"taskCardButton\" type=\"submit\" mat-raised-button color=\"primary\" (click)='createTask(newTaskEl.value)'>Add to List</button>\r\n                        </div>\r\n                    </div>\r\n                    <div class=\"row\" *ngIf=\"edited\">\r\n                        <div class=\"col-3 offset-5 offset-lg-6\">\r\n                            <div class=\"btn-group\">\r\n                                <button class=\"cardBtn\" id=\"taskCardButtonCancel\" type=\"button\" mat-raised-button color=\"warn\" (click)='cancelUpdateTask()'>Cancel</button>\r\n                                <button class=\"cardBtn\" id=\"taskCardButtonUpdate\" type=\"submit\" mat-raised-button color=\"primary\" (click)='updateTask(newTaskEl.value)'>Update</button>      \r\n                            </div>\r\n                        </div>\r\n                    </div>\r\n                </form>\r\n            </mat-card-actions>\r\n        </mat-card>\r\n        <br><br>\r\n    </div>\r\n</div>\r\n<div class=\"row\" *ngIf=\"loader\">\r\n    <div class=\"col-1 offset-5\">\r\n        <img src=\"../../assets/smloader2.gif\" alt=\"loading...\" class=\"loaderClass\"/>\r\n    </div>\r\n<br><br><br>\r\n</div>\r\n<div class=\"row\">\r\n    <div class=\"col\">\r\n        <h1>Your Tasks:</h1>\r\n    </div>\r\n</div>\r\n<div class=\"row heading\">\r\n    <div class=\"col-1\">\r\n        No.\r\n    </div>\r\n    <div class=\"col-8\">\r\n        Task\r\n    </div>\r\n    <div class=\"col-3\">\r\n        Actions\r\n    </div>\r\n</div>\r\n<br>\r\n\r\n<div *ngIf=\"taskIsEmpty\">\r\n<div class=\"row align-items-center justify-content-center alert\" style=\"padding-left: 3em;\">\r\n    <br><br>\r\n    <div class=\"col\">\r\n        Your To Do List is empty!!!\r\n    </div>\r\n</div>\r\n</div>\r\n\r\n    <ul>\r\n        <li *ngFor='let task of tasks, let i=index'>\r\n        <div class=\"row align-items-center justify-content-center tableData\">\r\n            <br><br>\r\n            <div class=\"col-1\" style=\"text-align: center;\">\r\n                {{i+1}}\r\n            </div>\r\n            <div class=\"col-8 limitChars\">\r\n                {{task.taskName}}\r\n            </div>\r\n            <div class=\"col-3\" style=\"text-align: center;\">\r\n                <button mat-icon-button color=\"primary\" (click)='editTask(i, task)'><mat-icon>edit</mat-icon></button>\r\n                <button mat-icon-button color=\"warn\" (click)='deleteTask(i, task)'><mat-icon>delete</mat-icon></button>\r\n            </div>\r\n        </div>\r\n        </li>\r\n    </ul>\r\n</div>       \r\n      <!--  <table class=\"table table-striped\">\r\n        <tbody align=\"left\">\r\n            <tr>\r\n                <th align=\"left\" class=\"tdStyle\">{{i+1}}</th>\r\n                <td align=\"left\" class=\"limitChars\">{{task.taskName}}</td>\r\n                <td align=\"right\" class=\"tdStyle\">\r\n                    <button mat-mini-fab color=\"primary\" (click)='editTask(i, task)'><mat-icon>edit</mat-icon></button>\r\n                    <button mat-mini-fab color=\"warn\" (click)='deleteTask(i, task)'><mat-icon>delete</mat-icon></button>\r\n                </td>\r\n            </tr>\r\n        </tbody>\r\n    </table>\r\n    </li></ul>\r\n</div>-->\r\n<footer class=\"page-footer\">\r\n    <div class=\"footer-copyright\">\r\n        <div class=\"foot container-fluid\">\r\n           Copy Rights  © 2018 &emsp; Hariharan M B S\r\n        </div>\r\n    </div>\r\n</footer>\r\n\r\n\r\n\r\n\r\n\r\n\r\n\r\n\r\n\r\n\r\n\r\n\r\n\r\n\r\n\r\n\r\n\r\n\r\n\r\n\r\n\r\n<!--<h2>{{task.taskName | uppercase}} Details</h2>\r\n<div><span>Id : </span>{{task.id}}</div>\r\n<div><span>Task Name : </span>{{task.taskName}}</div>\r\n<div>\r\n<label> Task Name: \r\n<input type=\"text\" [(ngModel)]=\"task.taskName\" placeholder=\"Name\">\r\n</label>\r\n</div>-->"
...
var TaskComponent = /** @class */ (function () {
    ...
    TaskComponent.prototype.getTasks = function () {
        ...
        this.taskService.getTasks().subscribe(function (taskRx) {
            ...
            if (_this.tasks.length == 0)
                _this.taskIsEmpty = true;
            else
                _this.taskIsEmpty = false;
    ...
    TaskComponent.prototype.deleteTask = function (index, taskToDelete) {
        var _this = this;
        if (confirm("Are you sure to delete Task : " + (index + 1) + ". " + taskToDelete.taskName)) {
            this.loader = true;
            if (this.edited == true) {
                this.edited = false;
                this.resetForm();
